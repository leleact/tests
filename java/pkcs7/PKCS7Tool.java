...
public class PKCS7Tool {
    ...
    public String sign(byte[] data) throws Exception {
        ...
        Constructor<ContentInfo> contentInfoConstructor = ContentInfo.class.getConstructor(new Class[]{data_oid.getClass(), derValue});
        Constructor<?> derValueConstructor = derValue.getConstructor(byte.class, byte[].class);
        contentInfo = (ContentInfo) contentInfoConstructor.newInstance(new Object[]{data_oid, derValueConstructor.newInstance((byte)4, data)});
        ...
        //SignerInfo  
        Constructor<SignerInfo> signerInfoConstructor = SignerInfo.class.getConstructor(  
            new Class[]{  
                x500Name,  
                BigInteger.class,  
                algorithmId,  
    ...
    private static void init() {
        ...
        System.out.println("vendorUC: " + vendorUC);
        try {  
